...
import (
	...
	"github.com/ryt-io/ryt-v2/proto/pb/platformvm"
	...
	acp99manager "github.com/ryt-io/icm-services/abi-bindings/go/validator-manager/ACP99Manager"
	erc20tokenstakingmanager "github.com/ryt-io/icm-services/abi-bindings/go/validator-manager/ERC20TokenStakingManager"
	examplerewardcalculator "github.com/ryt-io/icm-services/abi-bindings/go/validator-manager/ExampleRewardCalculator"
...
func InitializeValidatorSet(
	...
	log.Info("Initializing validator set", zap.Stringer("subnetID", l1Info.SubnetID))
