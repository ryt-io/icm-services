...
Currently required configurations are a small subset of the [`icm-relayer` configuration](https://github.com/ryt-io/icm-services/tree/main/relayer#configuration).
